...
This is an internal functionality in PROJ.
...
## Library wasm-proj
If you want to use the library on your own code, it is very is to use.
...
#### node
The library also works in `node`. Also the `WorkerBridge`.
...
```
The output can be big. More than 13000 entries.
